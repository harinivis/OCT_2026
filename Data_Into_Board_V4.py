...
def main():
    ...
    files = sorted(glob.glob(r"C:\Users\Harin\OneDrive\Capstone\forward_pipeline_outputs.mat"
                             ))
    ...
    for file in files:
        ...
        #load the tile
        mat_data = scipy.io.loadmat(file) #mat_data = scipy.io.loadmat(r"C:\Users\Harin\OneDrive\Capstone\forward_pipeline_outputs_scaled_000.mat")  
        
        #get the real data from file
