...
ascan_sample = bscan_data[10,:]
real_data = ascan_sample.real
complex_data = ascan_sample.imag
print('complex:')
print(complex_data)
print('real:')
print(real_data)
...
print('real:')
print(data_bytes[0:10]) #first ten real
print('complex:')
print(data_complex_bytes[500:512]) #last 12 values in imaginary
print('BOTH')
#print(data_bytes + data_complex_bytes)
combined_bytes = np.hstack((data_bytes, data_complex_bytes))
print(combined_bytes[0:10])
print(combined_bytes[1012:1024])
print('length')
